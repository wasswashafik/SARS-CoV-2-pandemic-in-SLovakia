...
dx(3) =             sigma*x(2)        -(gamma+mu/N)*x(3);     % (I) Differential equation for Infected cases. People recover but also die according to normal demographics.
dx(4) =             gamma*x(3)                 - mu*x(4)/N;   % (R) Differential equation for Removed cases. People recover, die from infection but also from natural cases.
end